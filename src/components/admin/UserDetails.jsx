...
function UserDetailsAdmin() {
    ...
    const fetchUserDetails = async () => {
        ...
        try {
            ...
            // http://localhost:8000/api/admin/user/all/
    ...
    const handleBlock = async (userId) => {
        try {
            const response = await axiosInstance.patch(`/api/admin/user/block/${userId}/`);
            console.log(response.data);
        ...
        <>
            ...
            <div className='flex'>
                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg lg:mt-0 ml-10 ">
                    <h1 className='m-4 dark:text-white'><b>User Details</b></h1>
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <TableHeader label={'FIRST NAME'} />

                                <TableHeader label={'JOINED DATE'} />
