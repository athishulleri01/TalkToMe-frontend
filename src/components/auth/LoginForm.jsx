...
function LoginForm() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(`${AUTH_URL}/api/login/`, data);
      console.log(".............")
      ...
      console.error("Error:", error.response.data.message);
        if (error.response.status === 406) {
         navigate(`/otp/${error.response.data.id}`);
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    className="text-sm font-medium dark:text-gray-400 text-primary-600 hover:underline dark:text-primary-500"
                  >
                    Forgot password?
                  </a>
                </div>
